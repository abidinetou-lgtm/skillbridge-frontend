...
export default function Register() {
  ...
  return (
    <main className="min-h-screen bg-[#F8F8F8] flex items-center justify-center py-16 px-4">
              ...
              <div className="flex items-center gap-4">
                <div className="w-20 h-20 rounded-full bg-[#E8E4DC] flex items-center justify-center overflow-hidden flex-shrink-0 border-2 border-dashed border-[#C0B8AC]">
                  {avatarPreview
                    ...
                    : <span className="text-[28px] text-[#C0B8AC] font-bold">{form.firstName?.[0] ?? '?'}</span>
                  }
                </div>
                <div>
                  ...
                  <p className="text-[11px] text-[#7A6E5C] mt-1">Optional · JPG, PNG</p>
                </div>
              </div>
