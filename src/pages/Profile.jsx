    ...
    <main className="pt-[62px] min-h-screen bg-[#F8F4EA]">
      ...
      <div className="px-8 md:px-16 max-w-[960px] mx-auto relative">
        ...
        <div className="flex items-end justify-between -mt-[52px] mb-5">
          <div className="w-[104px] h-[104px] rounded-full border-4 border-[#F8F4EA] bg-[#252840] flex items-center justify-center font-black text-[32px] text-white flex-shrink-0">
            {initials}
          </div>
